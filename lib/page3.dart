...
var projects = [
  ...
  project(
      ...
      project_desc: " An app using which one can easily run instructions in their system remotely from any location.",
      colour_box: [ Colors.red,
        Colors.pink,
        Colors.green,],
      project_tech: [ "Flutter", "Amazon Web Services", "Firebase"],
      project_linkedin: "https://www.linkedin.com/posts/muskan-modi-46b3751a7_flutter-rightmentor-activity-6715139814196318208-Tz0k/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3Binc%2Byl4LRUWgpXi2G50xgw%3D%3D",
      project_github: "https://github.com/muskan399/MobTerminal"),
  project(
      project_name: "MultiInterfaces - Web Utility for various technical task",
      project_desc: "A web interface that provides multiple services using one single interface. Using this user can easily interact with Docker, Cloud Services and some normal services as well.",
      colour_box: [],
      project_tech: ["BootStrap", "Docker", "AWS", "Python-CGI", "Apache Web Server"],
      project_linkedin: "https://www.linkedin.com/feed/update/urn:li:activity:6726373995429679104/",
      project_github: "https://github.com/muskan399/CGI_based_menu"),
  project(
      project_name: "MyCloud - Own cloud model",
      project_desc: "Deployed a cloud model using Kubernetes cluster with a load balancing capability.",
      colour_box: [],
      project_tech: ["Kubernetes", "Elastic Load Balancer", "MySQL", "Docker"],
      project_linkedin: "https://www.linkedin.com/post/edit/6686918169853992960/",
    ...
    var w=[
          ...
          Container(
            ...
            margin: EdgeInsets.only(
                top: MediaQuery.of(context).size.width * 30 / 1500),
            decoration:
