              ...
              for (var i = 0; i < widget.project_tech.length; i++)
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: widget.colour_box[i]),
                  child: Text(widget.project_tech[i],
                      style: TextStyle(color: Colors.black)),
                )
            ],
          ),
          ...
          Row(
            ...
            children: [
              InkWell(
                  ...
                  child: CircleAvatar(
                    backgroundImage: AssetImage("images/Linkedin-Logo.png"),
                  )),
              SizedBox(width: 6),
              InkWell(
                  onTap: () async {
